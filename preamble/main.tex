...
\newfontfamily{\jczPMingLiU}{JyutcitziWithPMingLiURegular}[Path = ./submodules/fonts/, Extension = .ttf]
% This has the best rendition for latin characters 
\newfontfamily{\jcz}{JyutcitziWithSourceHanSerifTCRegular}[Path = ./submodules/fonts/, Extension = .ttf]
\newfontfamily{\batang}{batang}[Path = ./submodules/fonts/, Extension = .ttf]
\newCJKfontfamily\koreanfont{Batang}[Path = ./submodules/fonts/, Extension = .ttf]
